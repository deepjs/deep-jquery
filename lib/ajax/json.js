...
define(["require", "deepjs/deep", "deep-restful/lib/http"], function(require, deep) {
	...
	deep.jquery.ajax = deep.jquery.ajax || {};
	deep.jquery.ajax.JSON = deep.compose.Classes(client, deep.store.HTTP);
	deep.jquery.ajax.json = function(protocol, baseURI, schema, options) {
		return new deep.jquery.ajax.JSON(protocol || "json", baseURI, schema, options);
	};
	return deep.jquery.ajax.json;
});